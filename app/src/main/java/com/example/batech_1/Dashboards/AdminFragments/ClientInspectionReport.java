...
public class ClientInspectionReport extends Fragment {
    ...
    private void showdata(String user_name) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        if(documentSnapshot.exists()){
                            if(task.getResult().exists()){
                                ...
                                services.add(Objects.requireNonNull(documentSnapshot.get("Checked Items")).toString());
    ...
    private void populateRecyc(ArrayList<String> services) {
